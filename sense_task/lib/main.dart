...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        //adminpage(Hive_box)
        //userpage(Hive_box)
       // (already_sign_in!)?loginpage(Hive_box):(already_sign_in==false&&pageview==2)?userpage(Hive_box):(already_sign_in==false&&pageview==1)?adminpage(Hive_box):loginpage(Hive_box)
